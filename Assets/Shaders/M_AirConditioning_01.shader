Shader "Unreal/M_AirConditioning_01"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_AirConditioning_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_AirConditioning_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_air_conditioning_R", 2D ) = "white" {}
		Material_Texture2D_3( "T_AirConditioning_M", 2D ) = "white" {}
		Material_Texture2D_4( "T_AirConditioning_AO", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_AirConditioning_01.hlsl"
