Shader "Unreal/M_Anti_tank_obstacle"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Antitank_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Antitank_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_Antitank_M", 2D ) = "white" {}
		Material_Texture2D_3( "T_Antitank_R", 2D ) = "white" {}
		Material_Texture2D_4( "T_Antitank_AO", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_Anti_tank_obstacle.hlsl"
