Shader "Unreal/M_Brick_painted_red"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_tile_floor_N_04", 2D ) = "white" {}
		Material_Texture2D_1( "T_BrickPaintedRed_N", 2D ) = "white" {}
		Material_Texture2D_2( "T_BrickPaintedRed_BC", 2D ) = "white" {}
		Material_Texture2D_3( "T_tile_floor_D_04", 2D ) = "white" {}
		Material_Texture2D_4( "T_BrickPaintedRed_R", 2D ) = "white" {}
		Material_Texture2D_5( "T_BrickRed_AO", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_Brick_painted_red.hlsl"
