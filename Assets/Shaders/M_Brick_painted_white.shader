Shader "Unreal/M_Brick_painted_white"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_BrickPaintedRed_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_BrickPaintedW_AO", 2D ) = "white" {}
		Material_Texture2D_2( "T_BrickRed_AO", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_Brick_painted_white.hlsl"
