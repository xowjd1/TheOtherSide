Shader "Unreal/M_FieldGrass_01"
{
    Properties
    {
		...
		GrassTipColor( "GrassTipColor", Color ) = (3.000000, 2.915346, 2.825072, 1.000000 )
		GrassDeadColor( "GrassDeadColor", Color ) = (4.000000, 3.243198, 2.620000, 1.000000 )
		SpecularAmount( "SpecularAmount", Float ) = 0.050000
		Roughness( "Roughness", Float ) = 0.400000
		StaticWPOHigh( "StaticWPOHigh", Float ) = 20.000000
		WPOWaveAmounttXYZ( "WPOWaveAmounttXYZ", Vector ) = (0.900000, 0.900000, -0.500000, 1.000000 )
