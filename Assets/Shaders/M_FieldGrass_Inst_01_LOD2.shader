Shader "Unreal/M_FieldGrass_Inst_01_LOD2"
{
    Properties
    {
		...
		GrassTipColor( "GrassTipColor", Color ) = (2.000000, 1.699959, 1.380000, 1.000000 )
		GrassDeadColor( "GrassDeadColor", Color ) = (9.000000, 7.297195, 5.895000, 1.000000 )
		SpecularAmount( "SpecularAmount", Float ) = 0.020000
		Roughness( "Roughness", Float ) = 0.600000
		SubsurfaceColorTint( "SubsurfaceColorTint", Color ) = (0.225000, 0.225000, 0.225000, 1.000000 )
    ...
    SubShader
    {
        ...
        #include "M_FieldGrass_Inst_01_LOD2.hlsl"
