...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local4 = (Local2.rgb * ((MaterialFloat3)2.00000000));
	MaterialFloat3 Local5 = lerp(Local4,Material.PreshaderBuffer[0].yzw,Material.PreshaderBuffer[0].x);
