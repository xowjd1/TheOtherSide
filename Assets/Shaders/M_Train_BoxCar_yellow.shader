Shader "Unreal/M_Train_BoxCar_yellow"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_train_box_car_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_train_box_car_yellow_D", 2D ) = "white" {}
		Material_Texture2D_2( "T_train_box_car_R", 2D ) = "white" {}
		Material_Texture2D_3( "T_train_box_car_AO", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_Train_BoxCar_yellow.hlsl"
