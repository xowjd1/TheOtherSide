Shader "Unreal/M_brightwhiewall"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Brightwhiewall_BC", 2D ) = "white" {}
		Material_Texture2D_1( "T_Brightwhiewall_M", 2D ) = "white" {}
		Material_Texture2D_2( "T_Brightwhiewall_R", 2D ) = "white" {}
