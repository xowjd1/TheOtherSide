Shader "Unreal/M_buildingdoors"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_BDoors_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_BDoors_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_BDoors_M", 2D ) = "white" {}
		Material_Texture2D_3( "T_BDoors_R", 2D ) = "white" {}
