Shader "Unreal/M_compensator"
{
    Properties
    {
		...
		Material_Texture2D_1( "T_compensator_D", 2D ) = "white" {}
		Material_Texture2D_2( "T_compensator_M", 2D ) = "white" {}
		Material_Texture2D_3( "T_compensator_R", 2D ) = "white" {}
		Material_Texture2D_4( "T_Compensator_AO", 2D ) = "white" {}
