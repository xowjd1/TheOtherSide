Shader "Unreal/M_compensator_base"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Compensator_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_Compensator_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_compensator02_M", 2D ) = "white" {}
		Material_Texture2D_3( "T_compensator02_R", 2D ) = "white" {}
		Material_Texture2D_4( "T_compensator02_AO", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_compensator_base.hlsl"
