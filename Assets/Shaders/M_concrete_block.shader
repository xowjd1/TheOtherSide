Shader "Unreal/M_concrete_block"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_concrete_blocks_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_concrete_blocks_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_concrete_blocks_R", 2D ) = "white" {}
		Material_Texture2D_3( "T_concrete_blocks_AO", 2D ) = "white" {}
