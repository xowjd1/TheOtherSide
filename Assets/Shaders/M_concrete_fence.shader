Shader "Unreal/M_concrete_fence"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_concrete_fence_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_concrete_fence_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_concrete_fence_R", 2D ) = "white" {}
		Material_Texture2D_3( "T_concrete_fence_AO", 2D ) = "white" {}
