Shader "Unreal/M_container_white"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_containet_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_containetW_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_containet_R", 2D ) = "white" {}
		Material_Texture2D_3( "T_containet_AO", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_container_white.hlsl"
