...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1].x = __SubsurfaceProfile;
	Material.PreshaderBuffer[1].y = RefractionDepthBias;
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local8 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 4);
	MaterialFloat4 Local9 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.PreshaderBuffer[1].x);
	PixelMaterialInputs.AmbientOcclusion = Local9.rgb;
	PixelMaterialInputs.Refraction = MaterialFloat3(MaterialFloat3(1.00000000,0.00000000,0.00000000).xy,Material.PreshaderBuffer[1].y);
