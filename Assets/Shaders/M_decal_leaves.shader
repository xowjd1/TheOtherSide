Shader "Unreal/M_decal_leaves"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_decal_leaves_BC", 2D ) = "white" {}
		Material_Texture2D_1( "T_decal_leaves_O", 2D ) = "white" {}
		Material_Texture2D_2( "T_decal_leaves_AO", 2D ) = "white" {}
