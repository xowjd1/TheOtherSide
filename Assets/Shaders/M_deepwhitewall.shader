Shader "Unreal/M_deepwhitewall"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_deepwhitewall_BC", 2D ) = "white" {}
		Material_Texture2D_1( "T_deepwhitewall_R", 2D ) = "white" {}
