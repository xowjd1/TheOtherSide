Shader "Unreal/M_drainage_pole"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_drainage_pole_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_drainage_pole_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_drainage_pole_R", 2D ) = "white" {}
