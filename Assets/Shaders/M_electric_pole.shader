Shader "Unreal/M_electric_pole"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_electric_pole_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_electric_pole_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_electric_pole_M", 2D ) = "white" {}
		Material_Texture2D_3( "T_electric_pole_R", 2D ) = "white" {}
		Material_Texture2D_4( "T_electric_pole_AO", 2D ) = "white" {}
