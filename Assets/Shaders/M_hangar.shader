Shader "Unreal/M_hangar"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_hangar_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_hangar_BC", 2D ) = "white" {}
		Material_Texture2D_2( "T_hangar_R", 2D ) = "white" {}
		Material_Texture2D_3( "T_hangar_AO", 2D ) = "white" {}
