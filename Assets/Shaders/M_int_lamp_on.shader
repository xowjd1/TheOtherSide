Shader "Unreal/M_int_lamp_on"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_int_lamp_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_int_lamp_emi", 2D ) = "white" {}
		Material_Texture2D_2( "T_int_lamp_BC", 2D ) = "white" {}
		Material_Texture2D_3( "T_int_lamp_R", 2D ) = "white" {}
		Material_Texture2D_4( "T_int_lamp_AO", 2D ) = "white" {}
