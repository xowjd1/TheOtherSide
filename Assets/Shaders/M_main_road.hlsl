...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local5 = UnpackNormalMap(Texture2DSampleBias(Material_Texture2D_1,samplerMaterial_Texture2D_1,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local6 = MaterialStoreTexSample(Parameters, Local5, 3);
	MaterialFloat4 Local7 = Parameters.VertexColor;
	MaterialFloat Local8 = DERIV_BASE_VALUE(Local7).a;
	MaterialFloat3 Local9 = lerp(Local2.rgb,Local5.rgb,DERIV_BASE_VALUE(Local8));
	MaterialFloat3 Local10 = DERIV_BASE_VALUE(Local7).rgb;
	MaterialFloat3 Local11 = (Local9 * DERIV_BASE_VALUE(Local10));
	...
	MaterialFloat3 Local12 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.PreshaderBuffer[0].yzw,Material.PreshaderBuffer[0].x);
	...
	MaterialFloat3 Local16 = (Local14.rgb * ((MaterialFloat3)0.12843999));
	MaterialFloat3 Local17 = lerp(Local14.rgb,Local16,DERIV_BASE_VALUE(Local8));
	MaterialFloat3 Local18 = (Local17 * DERIV_BASE_VALUE(Local10));
	MaterialFloat Local19 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 4);
	MaterialFloat4 Local20 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3,samplerMaterial_Texture2D_3,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local21 = MaterialStoreTexSample(Parameters, Local20, 4);
	MaterialFloat3 Local22 = lerp(Local20.rgb,MaterialFloat3(0.00000000,0.00000000,0.00000000).rgb,DERIV_BASE_VALUE(Local8));
	MaterialFloat3 Local23 = (Local22 * DERIV_BASE_VALUE(Local10));
	MaterialFloat Local24 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 0);
	MaterialFloat4 Local25 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_4,samplerMaterial_Texture2D_4,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
