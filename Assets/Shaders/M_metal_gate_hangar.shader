Shader "Unreal/M_metal_gate_hangar"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_metal_gate_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_metal_gate_D", 2D ) = "white" {}
		Material_Texture2D_2( "T_metal_gate_R_0", 2D ) = "white" {}
		Material_Texture2D_3( "T_metal_gate_AO", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_metal_gate_hangar.hlsl"
