Shader "Unreal/M_rusty_pipe"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_rusty_pipe_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_rusty_pipe_D", 2D ) = "white" {}
		Material_Texture2D_2( "T_rusty_pipe_R", 2D ) = "white" {}
		Material_Texture2D_3( "T_rusty_pipe_AO", 2D ) = "white" {}
