Shader "Unreal/M_tank_container"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_tank_container_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_tank_container_D", 2D ) = "white" {}
		Material_Texture2D_2( "T_tank_container_R", 2D ) = "white" {}
		Material_Texture2D_3( "T_tank_container_AO", 2D ) = "white" {}
