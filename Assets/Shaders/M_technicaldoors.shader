Shader "Unreal/M_technicaldoors"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_technicaldoors_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_technicaldoors_D", 2D ) = "white" {}
		Material_Texture2D_2( "T_technicaldoors_R", 2D ) = "white" {}
