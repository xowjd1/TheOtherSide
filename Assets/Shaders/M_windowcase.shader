Shader "Unreal/M_windowcase"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_windowcase_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_windowcase_D", 2D ) = "white" {}
		Material_Texture2D_2( "T_windowcase_R", 2D ) = "white" {}
