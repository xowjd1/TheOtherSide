Shader "Unreal/M_windowsbig"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_windowsbig_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_windowsbig_D", 2D ) = "white" {}
		Material_Texture2D_2( "T_windowsbig_R", 2D ) = "white" {}
